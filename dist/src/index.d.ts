import { setDebugMode } from './helpers';
 ...
 * @returns The result from the procedure.
 */
export declare function callClient<T = any>(player: Player | string, name?: string | any, args?: any, options?: CallOptions): Promise<T>;
/**
 ...
 * @returns The result from the procedure.
 */
export declare function callBrowsers<T = any>(player: Player | string, name?: string | any, args?: any, options?: CallOptions): Promise<T> | undefined;
/**
 ...
 * @param args - Any parameters for the event.
 */
export declare function triggerClient(player: Player | string, name?: string | any, args?: any): void;
/**
 ...
 * @param args - Any parameters for the event.
 */
export declare function triggerBrowsers(player: Player | string, name?: string | any, args?: any): void;
/**
